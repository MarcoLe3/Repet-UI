...
export default function MainHeroCard() {
    return(
        <main className="flex flex-col gap-8 relative justify-center items-center text-foreground bg-background-second text-light h-[80vh] w-screen">
            <h1 className="md:text-6xl sm:text-sm-font-heading font-semibold">Open Source UI Library.</h1>
            ...
            <Image
                src="/Cone.svg"
                alt="Cone"
                className='hidden absolute top-85 md:left-10 md:block'
                width={200}
                height={200}
            />
            <Image
                src="/Tree.svg"
                alt="Tree"
                className='hidden absolute top-65 right-5 md:block'
                width={250}
                height={250}
            />
        </main>
